...
/** Coins paid for finishing one stage of a chore. Agents get nothing. */
export const STAGE_PAY = 2;
...
export const STOCK = [
  ...
  {
    id: 'gun', name: 'THE FLARE PISTOL', cost: 48, side: 'both', icon: 'gun',
